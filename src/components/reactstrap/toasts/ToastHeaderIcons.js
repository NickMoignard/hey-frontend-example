            ...
            <TabContent activeTab={this.state.activeTab}>
              <TabPane tabId="1">
                <Row>
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="primary">Hey</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="success">Hey</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="info">Hey</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="danger">Hey</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="warning">Hey</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="dark">Hey</ToastHeader>
                      <ToastBody>
